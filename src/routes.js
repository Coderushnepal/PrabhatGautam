...
router.post(endpoints.ADD_TODO, authenticate, validateAddTodo, todoController.addTodo);

router.delete(endpoints.REMOVE_TODO, authenticate, todoController.removeTodo);

router.put(endpoints.UPDATE_TODO, authenticate, validateUpdateTodo, todoController.updateTodo);
